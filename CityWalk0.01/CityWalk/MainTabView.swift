    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            Group {
                ...
                case 0:
                    // 探索页面
                    ExploreMapView(sharedMapState: sharedMapState)
            ...
            // 底部Tab栏
            HStack {
                TabBarButton(title: "探索", systemImage: "globe", selected: selectedTab == 0) {
                    selectedTab = 0
                }
                Spacer()
                TabBarButton(title: "管家", systemImage: "person.2.fill", selected: selectedTab == 1) {
                    selectedTab = 1
                }
                Spacer()
